...
while bvals(5) == 0
   ...
   elseif region <= 5
      ...
      switch region
         ...
         case 3
            % Disc, mu = zeros of J_0(r), J_1(r) and J_2(r)

            mu = [bjzeros(0,3) bjzeros(1,3) bjzeros(2,3)];
         ...
         case 4
            % Circular sector , mu = zeros of J_(2/3)(r), J_(4/3)(r), J_2(r)

            mu = [bjzeros(2/3,3) bjzeros(4/3,3) bjzeros(2,3)];
      ...
      if modes
         ...
         p = [.02 .34 .68 .02 .34 .68 .02 .34 .68];
         q = [.68 .68 .68 .34 .34 .34 .02 .02 .02];
         for k = 1:9
            axes('position',[p(k) q(k) .30 .30]);
